...
define([
    ...
    'dojo/text!./Geoprocessing_Test/templates/Geoprocessing_Test.html',
    'dijit/form/Button'
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        templateString: gpTemplate,
        widgetsInTemplate: true,
        //mapClickMode: null,  need to reinstate this when switching to the real GPtool
