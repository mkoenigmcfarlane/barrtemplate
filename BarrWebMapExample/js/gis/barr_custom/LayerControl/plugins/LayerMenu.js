    ...
    return declare(Menu, {
        ...
        postCreate: function () {
            ...
            if (controlOptions.metadataUrl === true && layer.url) {
                ...
                menu.addChild(new MenuItem({
                    ...
                    onClick: function () {
						...
						//use line below to use proxy to authenticate access to rest service metadata (make sure to set proper proxy path depending on application home either on PM site or barr.com/maps site  - MST2
						//window.open('https://pm.barr.com/DotNet/proxy.ashx?' + layer.url, '_blank'); // use for site hosted on PM - MST2
            ...
            if (controlOptions.metadataUrl && typeof controlOptions.metadataUrl === 'string') {
			 ...
			 // download data or other hyperlink link - menu item feature added by MST2
            
            if (controlOptions.downloadUrl === true && layer.url) {
                menu.addChild(new MenuSeparator());
                menu.addChild(new MenuItem({
                    label: i18n.download,
                    onClick: function () {
            ...
            // custom data download url
            if (controlOptions.downloadUrl && typeof controlOptions.downloadUrl === 'string') {
                menu.addChild(new MenuSeparator());
                menu.addChild(new MenuItem({
                    label: i18n.download,
                    onClick: function () {
                        window.open(controlOptions.downloadUrl, '_blank');
                    }
                }));
            }
